...
const RecommendedDoctors = ({ docId, speciality }) => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
            ...
            <p className="sm:w-1/3 text-center text-sm">Dễ dàng duyệt qua danh sách rộng lớn các bác sĩ đáng tin cậy của chúng tôi</p>
            <div className="w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">
                {recDoc.slice(0, 5).map((item, index) => (
